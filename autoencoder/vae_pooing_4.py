...
if __name__ == '__main__':
    ...
    pca = PCA(n_components=4)  # or another number depending on how much dimensionality you want to reduce to
    ...
    def visualize_clusters(data, labels, original_pdb_path):
        ...
        io.save("coarse_grained_graph.pdb_7")
    ...
    # Use this after generating the PDB file to fix the issues:
