...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('model_new_4.pth'))
    ...
    linked = linkage(new_embeddings, 'ward')  # 'ward' is one method, you can explore 'single', 'complete', etc.
    ...
    def visualize_clusters(data, labels, original_pdb_path):
        ...
        # For writing to CSV
        with open('outputs/beads_to_atoms_5.csv', 'w', newline='') as csvfile:
            ...
            io.save("coarse_grained_graph.pdb_15")
